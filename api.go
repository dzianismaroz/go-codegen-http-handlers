...
// you can use ApiError in the code that results from generating
// We believe that this is some kind of well-known structure
...
// 2nd part
// this is a similar structure, with the same methods, but they have different parameters!
// the code created by your code generator works with a specific structure, knows nothing about others
// therefore, the fact that there is another similar structure nearby with the same methods does not bother him at all
